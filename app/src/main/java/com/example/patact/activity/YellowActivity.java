...
public class YellowActivity extends AppCompatActivity implements PatientAdapter.OnItemClickListener {

    private List<Patient> yellowList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (Patient patient : patientList) {
            ...
            if (prof != null) {
                ...
                if (prof.equals("Средняя тяжесть")) {
                    yellowList.add(patient);
                }
            }
        }

        // Инициализация адаптера и установка его в RecyclerView
        patientAdapter = new PatientAdapter(yellowList, this);
    ...
    private void performSearch(String searchText) {
        ...
        // Проход по всем элементам списка пациентов
        for (Patient patient : yellowList) {
    ...
    public void onItemClick(Patient patient) {
        ...
        Intent intent = new Intent(YellowActivity.this, PatientDetailsActivity.class);
